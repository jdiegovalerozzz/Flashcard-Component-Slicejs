...
export default class DeckViewPage extends HTMLElement {
    ...
    async renderContent() {
        ...
        console.log(`[DeckViewPage] Renderizando contenido para el ID de mazo: ${this.deckId}`);
        ...
        if (cards.length === 0) {
            ...
            customStudyButton.title = 'Study all cards in this deck, ignoring the schedule.';
